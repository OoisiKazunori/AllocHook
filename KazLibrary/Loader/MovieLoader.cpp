...
RESOURCE_HANDLE MovieLoader::Load(const MovieLoadData &MOVIE_DATA)
{
	...
	KazBufferHelper::BufferResourceData resourceData(heapProps, D3D12_HEAP_FLAG_SHARED, resDesc, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE, nullptr, "MovieBuff", BufferType::Texture, std::source_location::current());
